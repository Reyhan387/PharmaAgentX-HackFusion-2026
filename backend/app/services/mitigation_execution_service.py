...
def execute_mitigation_if_safe(medicine_id: int):
    ...
    try:
        ...
        # block execution immediately (same as SAFE MODE above)
        # -----------------------------------------------
        ...
        # -----------------------------------------------
        # ETHICAL ENFORCEMENT: if mode was escalated to REVIEW,
        # or original mode was REVIEW, route to pending review
        # -----------------------------------------------
